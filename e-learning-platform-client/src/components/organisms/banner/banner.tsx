...
export default function Banner({}: Props) {
  return (
    // <Carousel className="" autoplay={true} autoplayDelay={2000}>
    <div className="relative h-full w-full">
      <img src={img} alt="image 1" className="h-screen w-full object-cover" />
      <div className="absolute inset-0 h-full w-full place-items-center bg-black/75">
        <div className=" h-full ">
          <Typography
            // variant="h1"
            color="white"
            className="h-full flex justify-centers items-center lg:ms-22 md:ms-16 sm:ms-10 ms-5 font-bold  text-2xl sm:text-3xl  md:text-5xl "
          >
            Learn From Home
            <br />
            Learn Indepedently
